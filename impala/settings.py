"""
Django settings for impala project.
...
SECRET_KEY = 'qwd_fk@an&ef-$jcs5y%m6^081*jy2-s6q)*ws+)vx9k%a_$r9'
...
INSTALLED_APPS = [
    'maintenancemanager.apps.MaintenancemanagerConfig',
...
WSGI_APPLICATION = 'impala.wsgi.application'
...
STATIC_ROOT = "c:/ws/py/impala/static"
STATIC_URL = '/static/'
